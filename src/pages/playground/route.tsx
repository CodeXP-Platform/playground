...
export default function PlaygroundRoute() {
    ...
    return (
        <div className="flex h-dvh flex-col overflow-hidden bg-[radial-gradient(90%_130%_at_0%_0%,#121528_0%,transparent_50%),radial-gradient(110%_120%_at_100%_100%,#0f1f2d_0%,transparent_40%),#06070a] text-foreground">
            ...
            <main className="mx-auto grid min-h-0 w-full max-w-[1700px] flex-1 lg:grid-cols-[320px_minmax(0,1fr)]">
                <aside className="flex min-h-0 flex-col border-b border-white/10 bg-[#0a0c13] lg:border-r lg:border-b-0">
                ...
                <section className="flex min-h-0 flex-col bg-[#090b11]">
