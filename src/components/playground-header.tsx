    ...
    <header className="h-12 shrink-0 flex items-center justify-between px-4 border-b">
      ...
      <div className="flex items-center gap-2">
        ...
        <Select
          ...
          onValueChange={(value) => {
            const selected = solutions.find((s) => s.solutionId === value);
            if (selected) {
        ...
        >
          ...
          <SelectContent>
            {solutions.map((solution) => {
              const Icon = solution.language === "python" ? Python : Javascript;
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="min-w-40">
            <DropdownMenuItem>
              ...
              <a href="https://codexpweb.vercel.app/dashboard/profile">
                View Profile
              </a>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <LayoutDashboard className="size-4" />
              <a href="https://codexpweb.vercel.app/dashboard">
                Go to Dashboard
              </a>
            </DropdownMenuItem>
          </DropdownMenuContent>
